...
async fn main() {
    ...
    let auth_config = AxumAuthConfig::default().with_anonymous_user_id(Some(1));
    ...
    let app = Router::new()
        ...
        .layer(AuthSessionLayer::<User, AxumPgPool, PgPool>::new(Some(poll)).with_config(auth_config));
